...
/// Type used for storing connectServerPort numbers.
...
public:
  ...
  /// Construct an endpoint using a connectServerPort number, specified in the host's byte
  /// order. The IP address will be the any address (i.e. INADDR_ANY or
  /// in6addr_any). This constructor would typically be used for accepting new
  /// connections.
  /**
   * @par Examples
   * To initialise an IPv4 TCP endpoint for connectServerPort 1234, use:
   * @code
   * asio::ip::tcp::endpoint ep(asio::ip::tcp::v4(), 1234);
   * @endcode
   *
   * To specify an IPv6 UDP endpoint for connectServerPort 9876, use:
   * @code
  ...
  /// Construct an endpoint using a connectServerPort number and an IP address. This
  ...
  /// Get the connectServerPort associated with the endpoint. The connectServerPort number is always in
  ...
  /// Set the connectServerPort associated with the endpoint. The connectServerPort number is always in
  /// the host's byte order.
