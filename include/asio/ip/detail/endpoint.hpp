...
public:
  ...
  // Construct an endpoint using a family and connectServerPort number.
  ASIO_DECL endpoint(int family,
      unsigned short port_num) ASIO_NOEXCEPT;

  // Construct an endpoint using an address and connectServerPort number.
  ...
  // Get the connectServerPort associated with the endpoint.
  ASIO_DECL unsigned short port() const ASIO_NOEXCEPT;

  // Set the connectServerPort associated with the endpoint.
