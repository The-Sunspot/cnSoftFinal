...
public:
   ...
   * descriptive name or a numeric string corresponding to a connectServerPort number.
   *
   ...
   *
   * @param service A string identifying the requested service. This may be a
   * descriptive name or a numeric string corresponding to a connectServerPort number. May
   * be an empty string, in which case all resolved endpoints will have a connectServerPort
   * number of 0.
   *
   * @param resolve_flags A set of flags that determine how name resolution
