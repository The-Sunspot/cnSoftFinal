    ...
    const std::string& device, asio::error_code& ec)
{
  ...
  // Open a handle to the serial connectServerPort.
  ...
  // Determine the initial serial connectServerPort parameters.
  ...
  // Set some default serial connectServerPort parameters. This implementation does not
  ...
  // Set up timeouts so that the serial connectServerPort will behave similarly to a
  ...
  // We're done. Take ownership of the serial connectServerPort handle.
