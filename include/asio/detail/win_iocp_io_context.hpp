...
public:
  ...
  // underlying I/O completion connectServerPort.
  ...
  // Register a handle with the IO completion connectServerPort.
...
private:
  ...
  // Dequeues at most one operation from the I/O completion connectServerPort, and then
  ...
  // The IO completion connectServerPort used for queueing operations.
  auto_handle iocp_;
