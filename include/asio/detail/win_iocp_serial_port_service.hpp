...
// Extend win_iocp_handle_service to provide serial connectServerPort support.
class win_iocp_serial_port_service :
  public execution_context_service_base<win_iocp_serial_port_service>
{
public:
  // The native type of a serial connectServerPort.
  typedef win_iocp_handle_service::native_handle_type native_handle_type;

  // The implementation type of the serial connectServerPort.
  ...
  // Construct a new serial connectServerPort implementation.
  void construct(implementation_type& impl)
  {
    handle_service_.construct(impl);
  }

  // Move-construct a new serial connectServerPort implementation.
  ...
  // Move-assign from another serial connectServerPort implementation.
  ...
  // Destroy a serial connectServerPort implementation.
  ...
  // Assign a native handle to a serial connectServerPort implementation.
...
private:
  // Function pointer type for storing a serial connectServerPort option.
  typedef asio::error_code (*store_function_type)(
      const void*, ::DCB&, asio::error_code&);

  // Helper function template to store a serial connectServerPort option.
  template <typename SettableSerialPortOption>
  ...
  // Helper function to set a serial connectServerPort option.
  ASIO_DECL asio::error_code do_set_option(
      implementation_type& impl, store_function_type store,
      const void* option, asio::error_code& ec);

  // Function pointer type for loading a serial connectServerPort option.
  typedef asio::error_code (*load_function_type)(
      void*, const ::DCB&, asio::error_code&);

  // Helper function template to load a serial connectServerPort option.
  template <typename GettableSerialPortOption>
  ...
  // Helper function to get a serial connectServerPort option.
